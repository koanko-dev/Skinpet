      ...
      <Wrapper>
        ...
        <RightSideBox>
          ...
          <SubBox>
            ...
            기반으로 학습시킨 모델로 분석을 진행합니다. 현재 반려동물의 피부
            상태를 입력하여 해당되는 질환을 파악하고, 이미지 업로드를 통해 더욱
            자세히 파악할 수 있습니다. 의심되는 피부 부위를 선정하여 의심 정도를
            퍼센트로 나타내어 조기치료를 목표로 하고 있습니다. 질환명의 정의 및
            증상, 관리방법, 치료 과정에 대한 내용을 제공합니다.
          </SubBox>
        </RightSideBox>
      </Wrapper>
    </HomeThirdSectionBox>
